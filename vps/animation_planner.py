...
from algorithm_state import ComparisonState, MemoryState, empty_memory, memory_states_equal
...
def plan_from_visualization(viz: dict[str, Any], *, duration_sec: float | None = None) -> dict[str, Any]:
    ...
    from algorithm_state import ComparisonState, normalize_comparison_state, parse_visualization
